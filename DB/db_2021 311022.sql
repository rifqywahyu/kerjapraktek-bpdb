...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2022 at 11:55 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `spa_getlogin`(IN `pUser` VARCHAR(200), IN `pPass` VARCHAR(200))
BEGIN
	declare vUser int;
...
--
-- Table structure for table `tblatensi`
--

CREATE TABLE IF NOT EXISTS `tblatensi` (
...
--
-- Dumping data for table `tblatensi`
--

INSERT INTO `tblatensi` (`idtblatensi`, `idtbluser`, `idcuaca`, `atensi`, `latitude`, `longitude`, `create_time`, `flag`) VALUES
(1, 8, 1, 'ttttt', '-7.7383008', '110.4058223', '2022-04-15 07:36:56', 0);
...
--
-- Table structure for table `tblcuaca`
--

CREATE TABLE IF NOT EXISTS `tblcuaca` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tblcuaca`
--
...
INSERT INTO `tblinstansi` (`idtblinstansi`, `nama`, `alamat`, `tlpn`, `deskripsi`, `create_date`, `flag`, `tampil`) VALUES
(1, 'Bayu Induk', 'Komplek Pemda Sleman, Jl. Prasamya Sleman', '0274 869375', 'BPBD Sleman', '2017-09-29 15:35:27', 0, 1),
(2, 'PUSDALOPS Sleman', 'Jl. Kaliurang Km17.5, Pakem', '0274 2860051', 'BPBD Sleman', '2017-09-29 15:38:25', 1, 0),
(3, 'DLH', 'Jl. KRT. Pringgodiningrat, NO.9, Beran, Tridadi, Sleman', '081392125525', 'Bp. Karman ( Crane )', '2017-11-10 00:01:53', 0, 0),
(4, 'TELKOM', '-', '0811252767', 'Bagus', '2017-11-10 00:02:50', 0, 0),
(5, 'TELKOM', '-', '08124803321', 'Ibu Utami', '2017-11-10 00:03:31', 0, 0),
(6, 'PLN Sleman', '-', '0274 869455', 'Kantor UPJ Sleman', '2017-11-10 00:04:45', 1, 0),
(7, 'POSKO UTAMA PAKEM', 'Jl. Kaliurang Km17.5, Pakem', '0274 898350', 'TRC BPBD Sleman', '2017-11-10 00:05:43', 1, 0),
(8, 'AGNI Induk', 'Komplek Pemda Sleman, Jl. Prasamya Sleman', '0274 868351', 'PEMADAM KEBAKARAN SLEMAN', '2017-11-10 00:07:04', 1, 0),
(9, 'AGNI Godean', 'Jl. Godean', '0274 2821346', 'PEMADAM KEBAKARAN SLEMAN POS GODEAN', '2017-11-10 00:07:57', 1, 0),
(10, 'PGM Kaliurang', 'Kaliurang', '0274 895209', 'POS PANTAU KALIURANG', '2017-11-10 00:09:03', 0, 0),
(11, 'SAR KALIURANG', 'Kaliurang', '0274 868352', 'Pos Sar Kaliurang', '2017-11-10 00:09:56', 1, 0),
(12, 'PMI Sleman', '-', '0274 868900', 'Markas PMI Sleman', '2017-11-10 00:10:59', 1, 0),
(13, 'BASARNAS', 'Jl. Wates', '0274 6498080', 'Kantor BASARNAS', '2017-11-10 00:12:01', 1, 0),
(14, 'SAR POLDA', 'Jl. Ringroad Utara', '0851 0770 0767', '-', '2017-11-10 00:13:07', 0, 0),
(15, 'SAR POLDA', 'Jl. Ringroad Utara', '0274 7007606', '-', '2017-11-10 00:13:42', 0, 0),
(16, 'PLN Kalasan', '-', '0274 496317', 'Kantor PLN Kalasan', '2017-11-10 00:14:40', 1, 0),
(17, 'PLN Sedayu', '-', '0274 6497977', 'Kantor PLN Sedayu', '2017-11-10 00:15:16', 1, 0),
(18, 'PLN Sedayu', '-', '0274563348', 'Kantor PLN Sedayu', '2017-11-10 00:15:44', 1, 0),
(19, 'SES', 'Dinkes Sleman', '0274 8609000', '-', '2017-11-10 00:16:59', 0, 0),
(20, 'SES', 'Dinkes Sleman', '08112668900', '-', '2017-11-10 00:17:39', 0, 0),
(21, 'PLN Kota', '-', '0274 387365', 'Kantor PLN Kota', '2017-11-10 00:19:16', 1, 0),
(22, 'BPPTKG', '-', '0274 514192', 'Kantor BPPTKG', '2017-11-10 00:19:55', 1, 0),
(23, 'BMKG Iklim', '-', '0274 2880151', '-', '2017-11-10 00:20:39', 0, 0),
(24, 'BMKG Iklim', '-', '0274 2880152', '-', '2017-11-10 00:21:02', 0, 0),
(25, 'BMKG Gempa', '-', '0274 6498383', '-', '2017-11-10 00:21:34', 0, 0),
(26, 'PUSDALOPS DIY', 'Jl. Kenari, No.14A, Semaki, Umbulharjo, Yogyakarta', '0274 555584', 'BPBD DIY', '2017-11-10 00:23:44', 1, 0),
(27, 'PUSDALOPS DIY', 'Jl. Kenari, No.14A, Semaki, Umbulharjo, Yogyakarta', '0274 555585', 'BPBD DIY', '2017-11-10 00:24:17', 0, 0),
(28, 'PLN Sleman', '-', '085722260237', 'ANDRI/ ARDI', '2017-11-11 13:29:10', 0, 0),
(29, 'SRIYONO', 'Balong, Umbulharjo, Cangkringan', '085878212444', 'TAGANA', '2017-12-03 18:09:53', 0, 0),
(30, 'Juwaryono (Dukuh Kemiri Sewu)', 'Kemiri Sewu/Brongkol Sidorejo Godean', '085878711196', 'Dukuh Kemiri Sewu / Brongkol', '2018-03-28 00:44:43', 0, 0),
(31, 'POLDA DIY', 'Jl. Ringroad Utara Condong Catur Depok', '(0274) 886000', 'Kantor', '2018-03-28 00:47:39', 0, 0),
(32, 'POLRES SLEMAN', 'Jl. Magelang Km. 12 Kec. Sleman', '(0274) 868424', 'Kantor', '2018-03-28 00:50:11', 0, 0),
(33, 'PMI Sleman', 'Jl. Dr. Rajimin Sucen', '(0274) 869909', 'Unit Donor Darah', '2018-03-28 00:52:45', 1, 0),
(34, 'Agustha Purwa Aji K', 'Pete, Selomartani, Kalasan', NULL, NULL, '2019-01-08 03:55:34', 0, 0),
(35, 'PLN Sleman', '-', '085227593875', 'TEGAR', '2019-11-30 18:35:55', 0, 0),
(36, 'paijo', 'sasasas', '6666666666', 'ssdsd', '2022-05-01 01:53:55', 1, 0);
...
CREATE TABLE IF NOT EXISTS `tblkey` (
  `id` int(11) NOT NULL,
...
(1, '1212121212121', 'Roni', '23232323', 'Sleman', '2022-10-04', 'suami', 'laki-laki', 1, 'menikah', 'rererer', 'Indo', 2, 21, '12', '11', '', 0, '2022-10-22 19:37:17', 0);
...
--
-- Table structure for table `tblkml`
--

CREATE TABLE IF NOT EXISTS `tblkml` (
  `id` int(11) NOT NULL,
  `nama` varchar(100) DEFAULT NULL,
...
(40, 'aaaas', 'zxsdsds', 1, 340401, 'sdsdsd', 1, '2022-08-31', '1', '1', 'ada', 'sdsd', '1212', '2121', '1', '2022-08-25', 'sdsd', '1221', '1212', '1', 'asdsds', 'sdsdsds', NULL, NULL, NULL);
...
INSERT INTO `tbllaporan` (`idtbllaporan`, `idtbluser`, `nir`, `nama`, `kelurahan`, `dusun`, `bencana`, `tgl_kejadian`, `rt`, `rw`, `latitude`, `longitude`, `flag`, `status`, `create_time`, `create_by`, `update_time`, `update_by`, `dampak`, `rangkuman_korban`, `notelp`, `imei`, `flag_tracking`, `ditracking`) VALUES
(1, NULL, '1212', 'sdsds', 1, '2', 1, '2022-08-03 04:30:00', '23', '2', '-7.8122949', '110.2981151', 1, 'proses', '2022-08-03 01:02:08', '1', '2022-10-22 18:48:31', '1', 'asasasasasas', '-', '12121', NULL, 0, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `tbllaporan_bantuan`
--

CREATE TABLE IF NOT EXISTS `tbllaporan_bantuan` (
  `idbantuan` int(11) NOT NULL,
  `idtbllaporan` int(11) DEFAULT NULL,
  `idtblbarang` int(11) DEFAULT NULL,
  `jml` int(11) DEFAULT NULL,
  `waktu` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `idtblkaryawan` int(11) DEFAULT NULL,
  `keterangan` varchar(500) DEFAULT NULL,
  `hambatan` varchar(500) DEFAULT NULL,
...
(1, 1, 109, 1, '2022-10-22 18:24:25'),
(2, 1, 31, 1, '2022-10-22 18:46:26');
...
--
-- Table structure for table `tbllaporan_progres`
--

CREATE TABLE IF NOT EXISTS `tbllaporan_progres` (
  `idprogres` int(11) NOT NULL,
  `idtbllaporan` int(11) DEFAULT NULL,
  `idpenanganan` int(11) DEFAULT NULL,
...
(48, 'Master Penanganan', 'mdi-action-settings', '2', 'ms_penanganan', 23, 0, NULL);
...
CREATE TABLE IF NOT EXISTS `tblpenanganan` (
  `idpenanganan` int(9) NOT NULL,
  `nama` varchar(300) DEFAULT NULL,
  `deskripsi` text,
  `create_user` varchar(30) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
...
INSERT INTO `tblpenanganan` (`idpenanganan`, `nama`, `deskripsi`, `create_user`, `create_time`, `flag`) VALUES
(14, 'Asesmen Kejadian', 'Penanganan Awal', NULL, '2022-10-22 21:35:19', 0),
(15, 'Proses Penanganan Darurat', 'Penanganan Awal', NULL, '2022-10-22 21:50:04', 0),
(16, 'Selesai Penanganan Darurat', 'Penanganan Awal', NULL, '2022-10-22 21:50:33', 0),
(17, 'Proses Pemberian Logistik Darurat', 'Penanganan Awal', NULL, '2022-10-22 21:52:23', 0),
(18, 'Logistik Telah Diterima', 'Penanganan Awal', NULL, '2022-10-22 21:52:56', 0),
(19, 'Asesmen Rehab Rekon', 'Rehabilitasi dan Rekonstruksi', NULL, '2022-10-22 21:53:27', 0),
(20, 'Proses Pengerjaan', 'Rehabilitasi dan Rekonstruksi', NULL, '2022-10-22 21:53:57', 0),
(21, 'Rehabilitasi dan rekonstruksi Selesai', 'Rehabilitasi dan Rekonstruksi', NULL, '2022-10-22 21:54:36', 0),
(22, 'Penanganan Selesai', 'Seluruh proses penanganan selasai kedaan sudah kembali seperti semula.', NULL, '2022-10-22 21:55:12', 0);
...
(1, 'Informasi Cuaca ', 'Kabupaten sleman secara umum terpantau cuaca cerah berawan, kondusif aman.', '2022-08-21 07:28:51', 0);
...
(1, NULL, 'Dikau Mardika', 'dikau.blank@gmail.com', '085643233547', NULL, 1, 'c1101a9af7078ca6f36ee25a3b298e0c', '2018-02-06 23:48:12', '', '2022-04-12 16:44:58', 0, NULL, NULL, NULL),
...
(8, NULL, 'Nisa', 'dikau.mardika@gmail.com', '123456', NULL, 5, 'e10adc3949ba59abbe56e057f20f883e', '2022-04-13 15:00:25', NULL, NULL, 0, 'fuIMc5vqQCW287_bgOi1Xq:APA91bH9dfIrWO6V5s50fExbQGFW6MiwDvEush8YfU-3LmK9YNbaltPbRqRwIMHdQBZ3QkI2ojjC84iDJxkeSxytA_V9ScHe0cG-vA6ScJ5k6vovD4rA_QeUw3f-2JjN5Fr4Ai5I2hEC', '2022-04-28 20:43:02', 'MANUFACTURE : Xiaomi\nMODEL : Redmi Note 9 Pro\nPRODUCT : joyeuse_id\nSDK VERSION :  30\nOPERATOR :  INDOSAT\n');
...
--
-- Indexes for table `tbllaporan_bantuan`
--
ALTER TABLE `tbllaporan_bantuan`
  ADD PRIMARY KEY (`idbantuan`),
  ADD KEY `idtblbarang` (`idtblbarang`),
...
--
-- Indexes for table `tbllaporan_progres`
--
ALTER TABLE `tbllaporan_progres`
  ADD PRIMARY KEY (`idprogres`),
  ADD KEY `idtbllaporan` (`idtbllaporan`),
  ADD KEY `idtblkaryawan` (`idpenanganan`);
...
ALTER TABLE `tblpenanganan`
  ADD PRIMARY KEY (`idpenanganan`) USING BTREE;
...
--
ALTER TABLE `admin_access`
  MODIFY `id` int(12) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1560;
--
...
--
-- AUTO_INCREMENT for table `tblatensi`
--
ALTER TABLE `tblatensi`
  MODIFY `idtblatensi` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `tblcuaca`
--
ALTER TABLE `tblcuaca`
...
--
ALTER TABLE `tblinstansi`
  MODIFY `idtblinstansi` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=37;
--
...
--
ALTER TABLE `tblkk`
  MODIFY `idtblkk` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `tblkml`
--
ALTER TABLE `tblkml`
...
--
ALTER TABLE `tblkomunitas`
  MODIFY `idtblkomunitas` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=41;
--
...
--
ALTER TABLE `tbllaporan`
  MODIFY `idtbllaporan` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `tbllaporan_bantuan`
--
ALTER TABLE `tbllaporan_bantuan`
  MODIFY `idbantuan` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbllaporan_detail`
--
ALTER TABLE `tbllaporan_detail`
  MODIFY `idtbllaporan_det` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
-- AUTO_INCREMENT for table `tbllaporan_progres`
--
ALTER TABLE `tbllaporan_progres`
  MODIFY `idprogres` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tblmenu`
  MODIFY `idtblmenu` int(12) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=49;
--
-- AUTO_INCREMENT for table `tblpenanganan`
--
ALTER TABLE `tblpenanganan`
  MODIFY `idpenanganan` int(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `tblperingatandini`
  MODIFY `idperingatan` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tbluser`
  MODIFY `idtbluser` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
-- Constraints for table `tbllaporan_bantuan`
--
ALTER TABLE `tbllaporan_bantuan`
  ADD CONSTRAINT `tbllaporan_bantuan_ibfk_1` FOREIGN KEY (`idtblbarang`) REFERENCES `tblbarang` (`idtblbarang`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tbllaporan_bantuan_ibfk_2` FOREIGN KEY (`idtblkaryawan`) REFERENCES `tblkaryawan` (`idtblkaryawan`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tbllaporan_bantuan_ibfk_3` FOREIGN KEY (`idtbllaporan`) REFERENCES `tbllaporan` (`idtbllaporan`);
...
--
-- Constraints for table `tbllaporan_progres`
--
ALTER TABLE `tbllaporan_progres`
  ADD CONSTRAINT `tbllaporan_progres_ibfk_1` FOREIGN KEY (`idtbllaporan`) REFERENCES `tbllaporan` (`idtbllaporan`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tbllaporan_progres_ibfk_2` FOREIGN KEY (`idpenanganan`) REFERENCES `tblpenanganan` (`idpenanganan`) ON DELETE CASCADE ON UPDATE CASCADE;
