                  ...
                  <div class="row">
                    <div class="col s12 m12 l12">
                      <div class="card-panel">
                        <h4 class="header2">Tambah Master desa</h4>
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_desa/proses_tambah" method="post">
                            <div class="row">
                            ...
                            <div class="row">
                              ...
                              <!-- <div class="input-field col m2 s6">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="radius" required type="number" data-error=".errorTxtw5">
