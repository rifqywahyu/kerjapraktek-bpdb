...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Master Peta Kawasan Rawan Bencana Gunung Merapi</h4>
                      <div class="row">
                        <div class="col s12 m12 l12">
                          ...
                          <thead>
                              <tr>
                                  ...
                                  <th style="width: 7%;">Lokasi File</th>
                  ...
                  <!-- <div class="row">
                    ...
                    <div class="fixed-action-btn tooltipped" style="bottom: 50px; right: 19px;" data-position="left" data-delay="50" data-tooltip="Tambah">
                        <a class="btn-floating btn-large" href="<?php echo base_url()?>ms_kml/tambah ">
    ...
    $(document).on('click', '.link_delete', function (e) {
     ...
     $(document).on('click', '.link_icon', function (e) {
          ...
          $("#data_icon").attr("src", "<?php echo base_url()?>uploads/kml/"+nama);
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>Ms_kml/get_kml",
           dataType: 'json',
            beforeSend:function()
            {
