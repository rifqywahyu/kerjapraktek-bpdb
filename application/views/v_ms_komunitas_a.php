                  ...
                  <div class="row">
                    <div class="col s12 m12 l12">
                      <div class="card-panel">
                        ...
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_komunitas/proses_tambah" method="post">
                            <div class="row">
                            ...
                            <div class="row">
                              <div class="input-field col m3 s6">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="desa" type="text" required  data-error=".errorTxt9">
                                <div class="errorTxt9"></div>
                                <label for="first_name">Desa</label>
                              </div>
                              <div class="input-field col m3 s6">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="masa_bakti" type="text" required data-error=".errorTxt10">
                                <div class="errorTxt10"></div>
                                <label for="first_name">Masa Bakti Pengurus</label>
                              </div>
                              <div class="input-field col m3 s6">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="jml_pengurus" type="number" required data-error=".errorTxt121">
                                <div class="errorTxt121"></div>
                                <label for="first_name">Jumlah Pengurus</label>
                              </div>
                              <div class="input-field col m3 s6">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="jml_anggota" type="number" required data-error=".errorTxt132">
                            ...
                            <div class="row">
                              ...
                              <div class="input-field col m3 s6">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="tanggal_berakhir" type="date" class="datepicker" required data-error=".errorTxt11">
                                <div class="errorTxt11"></div>
                                <label for="first_name">Tanggal berakhir pengurus</label>
                              </div>
                              <div class="input-field col m3 s6">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="kepemilikan_adart" type="text" required data-error=".errorTxt12">
                                <div class="errorTxt12"></div>
                                <label for="first_name">Kepemilikan ADART</label>
                              </div>
                              <div class="input-field col m3 s6">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="tlpn_sekretariat" type="text" required data-error=".errorTxt8">
                                <div class="errorTxt8"></div>
                                <label for="first_name">No tlpn Sekretariat</label>
                              </div>
                              <div class="input-field col m3 s6">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="tlpn_alternative" required type="text" data-error=".errorTxt5">
                            ...
                            <div class="row">
                              <div class="input-field col m3 s6">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="kemampuan" type="text" required data-error=".errorTxt6">
                                <div class="errorTxt6"></div>
                                <label for="first_name">Kemampuan</label>
                              </div>
                              <div class="input-field col m3 s6">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="pertemuan_rutin" type="text" data-error=".errorTxt7" required title="Harap Di isi">
                                <div class="errorTxt7"></div>
                                <label for="first_name">Pertemuan Rutin</label>
                              </div>
                              <div class="input-field col m3 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="tanggal_berdiri" required type="date" class="datepicker" data-error=".errorTxt13">
                                <div class="errorTxt13"></div>
                                <label for="first_name">Tanggal Berdiri</label>
                              </div>
                              <div class="input-field col m3 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="pejabat" required type="text" data-error=".errorTxt14">
                            ...
                            <div class="row">
                              <div class="input-field col m3 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="frex_rx" required type="text" data-error=".errorTxt141">
                                <div class="errorTxt141"></div>
                                <label for="first_name">Free RX</label>
                              </div><div class="input-field col m3 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="frex_tx" required type="text" data-error=".errorTxt142">
                                <div class="errorTxt142"></div>
                                <label for="first_name">Free TX</label>
                              </div>
                              <div class="input-field col m3 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="tone" type="text" required data-error=".errorTxt16">
                                <div class="errorTxt16"></div>
                                <label for="first_name">Tone</label>
                              </div>
                              <div class="input-field col m3 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="peralatan" type="text" required data-error=".errorTxt17">
                                <div class="errorTxt16"></div>
                            ...
                            <div class="row">
                              <div class="input-field col m12 s12">
                                ...
                                <textarea id="message3" name="ket" required class="materialize-textarea" data-error=".errorTxt15"></textarea>
