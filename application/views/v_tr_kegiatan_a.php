                            ...
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="card-panel">
                                        ...
                                        <div class="row">
                                            <form class="col s12" id="formValidate" enctype="multipart/form-data" action="<?php echo base_url()?>tr_kegiatan/proses_tambah" method="post">
                                                <div class="row">
                                                  <div class="row">
                                                    <div class="input-field col m6 s12">
                                                        <i class="mdi-action-account-circle prefix"></i>
                                                        <input id="nama_kegiatan" name="nama_kegiatan" type="text" data-error=".errorTxt1">
                                                        <div class="errorTxt1"></div>
                                                        <label for="no_induk">Nama Kegiatan</label>
                                                    </div>
                                                    <div class="input-field col m6 s12">
                                                        <i class="mdi-action-account-circle prefix"></i>
                                                        <input id="tema" name="tema" type="text" data-error=".errorTxt1">
                                                        <div class="errorTxt1"></div>
                                                        <label for="no_induk">Tema</label>
                                                    </div>
                                                    <div class="input-field col m6 s12">
                                                        <i class="mdi-action-account-circle prefix"></i>
                                                        <input id="lokasi" name="lokasi" type="text" data-error=".errorTxt1">
                                                        <div class="errorTxt1"></div>
                                                    ...
                                                    <div class="input-field col m5 s12" style="padding-left:55px;">
                                                        <select name="komunitas" id="komunitas" class="select" required title="Harap Di pilih" data-error=".errorTxt3">
                                                            ...
                                                            <?php foreach($komunitas as $row){ ?>
                                                                <option value="<?php echo $row->idtblkomunitas?>">
                                                                    <?php echo $row->nama ?>
                                                                </option>
                                                                <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col m12 s12">
                                                            ...
                                                            <textarea id="alamat" name="alamat" required class="materialize-textarea" data-error=".errorTxt15"></textarea>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col m4 s12">
                                                            <i class="mdi-action-account-circle prefix"></i>
                                                            <input name="tanggal_kegiatan" type="date" class="datepicker" required data-error=".errorTxt11" value="<?php echo date((" Y-m-d "), strtotime('1990-01-01'))?>">
                                                            <div class="warna_error errorTxt11"></div>
                                                            <label for="first_name">Tanggal Kegiatan</label>
                                                        </div>
                                                        <div class="input-field col m4 s12">
                                                            <i class="mdi-action-account-circle prefix"></i>
                                                            <input name="penanggung_jawab" type="text" required data-error=".errorTxt132">
            ...
            <?php include("inc/js.php") ?>
                ...
                <script>
                    ...
                    $("#kelurahan").change(function(e) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url();?>tr_kegiatan/get_dusun",
                            data: {
                              "idkec" : $('#kecamatan').val(),
                              "idkel" : $(this).val(),
                            },
