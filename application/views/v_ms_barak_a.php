                  ...
                  <div class="row">
                    <div class="col s12 m12 l12">
                      <div class="card-panel">
                        <h4 class="header2">Tambah Master Barak</h4>
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_barak/proses_tambah" method="post">
                            <div class="row">
                            ...
                            <div class="row">
                              ...
                              <div class="input-field col m3 s6">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="tampung" type="text" data-error=".errorTxt5">
