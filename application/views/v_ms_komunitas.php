...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Master komunitas</h4>
                      <div class="row">
                        <div class="col s12 m12 l12">
                          ...
                          <thead>
                              <tr>
                                  ...
                                  <th style="width: 7%;">Masa Bakti</th>
                                  <th style="width: 7%;">Tanggal Berakhir</th>
                                  <th style="width: 7%;">Jumlah Pengurus</th>
                                  <th style="width: 7%;">Jumlah Anggota</th>
                                  <th style="width: 7%;">Kepemilikan Adart</th>
                                  <th style="width: 7%;">Kemampuan</th>
                                  <th style="width: 7%;">Telepon Sekretariat</th>
                                  <th style="width: 7%;">Telepon Alternative</th>
                                  <th style="width: 7%;">Pertemuan Rutin</th>
                                  <th style="width: 7%;">Tanggal Berdiri</th>
                                  <th style="width: 7%;">Pejabat</th>
                                  <th style="width: 7%;">Frex RX</th>
                                  <th style="width: 7%;">Frex TX</th>
                                  <th style="width: 7%;">Tone</th>
                                  <th style="width: 7%;">Peralatan</th>
                  ...
                  <!-- <div class="row">
                    ...
                    <div class="fixed-action-btn tooltipped" style="bottom: 50px; right: 19px;" data-position="left" data-delay="50" data-tooltip="Tambah">
                        <a class="btn-floating btn-large" href="<?php echo base_url()?>ms_komunitas/tambah ">
    ...
    $(document).on('click', '.link_delete', function (e) {
     ...
     $(document).on('click', '.link_foto', function (e) {
          ...
          $.ajax({
             type: "POST",
             url: "<?php echo base_url();?>ms_komunitas/get_image",
          ...
          $("#title_foto").html("Foto komunitas "+nama);
          // $("#data_icon").attr("src", "<?php echo base_url()?>uploads/komunitas/"+foto);
    ...
    //   });
     ...
     $(document).on('click', '.link_map', function (e) {
          ...
          var nama = $(this).attr('data-nama');
          $("#modal_title").text("Koordinat komunitas : "+nama);
          elos_ganteng(latitude, longitude);
          // console.log(link+"_"+nama);
          // $("#data_icon").attr("src", "<?php echo base_url()?>uploads/komunitas/"+icon);
          $('#modal5').openModal();
         e.preventDefault();
      });
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>Ms_komunitas/get_komunitas",
           dataType: 'json',
            beforeSend:function()
            {
