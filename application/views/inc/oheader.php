		...
		<nav class="navbar-color">
			<div class="nav-wrapper">
				<ul class="left">
				  ...
				  <li><h5 class="logo-wrapper"><a href="<?php echo base_url()?>" class="brand-logo darken-1"><img src="<?php echo base_url()?>assets/img/logo.png" alt="materialize logo"></a> <span class="logo-text"></span></h1></li>
				</ul>
		 ...
		 <nav id="horizontal-nav" class="white hide-on-med-and-down">
			...
			<?php } } ?>
					...
					<!-- <li style="margin-right:15px;">
						<a class="cyan-text" href="<?php echo base_url()?>main/tambah">
							<i class="mdi-action-settings-phone"></i>
							<span>Lapor </span>
						</a>
					</li> -->
					<li>
						<a class="cyan-text" href="http://103.71.191.193:8080/mapstore/" target="_blank">
							<i class="mdi-communication-location-on"></i>
							<span>WebGIS </span>
						</a>
					</li>
					<li>
						<a class="cyan-text" href="https://www.sdin.slemankab.go.id" target="_blank">
							<i class="mdi-communication-business"></i>
							<span>SDIN </span>
						</a>
					</li>
					<li>
						<a class="cyan-text" href="<?php echo base_url()?>Ms_Peta_Cuaca">
					...
					<li>
						...
						<a class="cyan-text" href="<?php echo base_url()?>login">
							<i class="mdi-action-get-app"></i>
							<span>Login </span>
						</a>
