                  ...
                  <div class="row">
                    <div class="col s12 m12 l12">
                      <div class="card-panel" style="padding-top:1px;">
                        <h4 class="header2" style="text-align:center">Laporan Peta Kejadian
                          <?php if($range != ' - '){
                              echo $range;
                          }else{
                            echo "Hari Ini";
                 ...
                 ['<div id="iw-container">' +
                    ...
                    '<div class="iw-content">' +
                      ...
                      <?php foreach ($data_detail as $rows) { ?>                        <?php if ($rows->type == '1') { ?>
                          '<img src="<?php echo base_url().'uploads/kejadian/'.$rows->picture_name?>" data-nama="<?php echo strtoupper($row->nama_bencana) ?>'+' DI DUSUN '+'<?php echo strtoupper($row->nama_dusun) ?>" class="img" height="120" width="100%"><br />' +
                        <?php }else{ ?>
                          '<video width="100%" height="100%" src="<?php echo base_url().'uploads/kejadian/'.$rows->picture_name?>" class="video" data-nama="<?php echo strtoupper($row->nama_bencana) ?>'+' DI DUSUN '+'<?php echo strtoupper($row->nama_dusun) ?>" controls><source src="<?php echo base_url().'uploads/kejadian/'.$row->idtbllaporan.'/'.$rows->picture_name?>" type="video/mp4">Your browser does not support HTML5 video </video>'+
                        <?php } ?>
                      <?php } ?>
                    '</div>' +
