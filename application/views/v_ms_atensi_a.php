                  ...
                  <div class="row">
                    <div class="col s12 m12 l12">
                      <div class="card-panel">
                        <h4 class="header2">Tambah Master relawan</h4>
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_relawan/proses_tambah" method="post">
                            <div class="row">
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input id="no_induk" name="no_induk" type="text" data-error=".errorTxt1">
                                <div class="errorTxt1"></div>
                                <label for="no_induk">NRR/No Induk</label>
                              </div>
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                  <input id="nik" name="nik" type="text" data-error=".errorTxt1">
                                  <div class="errorTxt1"></div>
                                  <label for="nik">NIK</label>
                                </div>
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input id="name3" name="nama_relawan" type="text" data-error=".errorTxt1">
                                <div class="errorTxt1"></div>
                            ...
                            <div class="row">
                              ...
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="tanggal_lahir" type="date" class="datepicker" required data-error=".errorTxt11" value="<?php echo date(("Y-m-d"), strtotime('1990-01-01'))?>">
                                ...
                                <div class="input-field col m5 s6">
                                  <select name="kecakapan" id="kecakapan" class="select" required title="Harap Di pilih" data-error=".errorTxt3">
                                    ...
                                    <option value="<?php echo $row->idtblkecakapan?>"><?php echo $row->nama ?></option>
                                  <?php } ?>
                                  </select>
                                  <div class="errorTxt3"></div>
                                  <!-- <label>Desa / Kelurahan</label> -->
                                ...
                                <div class="input-field col m5 s12" >
                                  <select name="komunitas" id="komunitas" class="select" required title="Harap Di pilih" data-error=".errorTxt3">
                                    ...
                                    <option value="<?php echo $row->idtblkomunitas?>"><?php echo $row->nama ?></option>
                                  <?php } ?>
                                  </select>
                                  <div class="errorTxt3"></div>
                                  <!-- <label>Desa / Kelurahan</label> -->
