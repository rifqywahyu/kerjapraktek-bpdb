...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Master Barak</h4>
                      <div class="row">
                  ...
                  <!-- <div class="row">
                    ...
                    <div class="fixed-action-btn tooltipped" style="bottom: 50px; right: 19px;" data-position="left" data-delay="50" data-tooltip="Tambah">
                        <a class="btn-floating btn-large" href="<?php echo base_url()?>ms_barak/tambah ">
    ...
    $(document).on('click', '.link_delete', function (e) {
     ...
     $(document).on('click', '.link_foto', function (e) {
          ...
          $("#title_foto").html("Foto Barak "+nama);
          $("#data_icon").attr("src", "<?php echo base_url()?>uploads/barak/"+foto);
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>Ms_barak/get_barak",
           dataType: 'json',
            beforeSend:function()
            {
