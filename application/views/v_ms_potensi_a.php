                  ...
                  <div class="row">
                    <div class="col s12 m12 l12">
                      <div class="card-panel">
                        ...
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_Potensi/proses_tambah" method="post">
                            <div class="row">
                            ...
                            <div class="row">
                              <div class="input-field col m3 s6">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="penanggungjawab" type="text" required  data-error=".errorTxt9">
