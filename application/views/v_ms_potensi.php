...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Master Potensi Penanganan Covid 19</h4>
                      <div class="row">
                  ...
                  <!-- <div class="row">
                    ...
                    <div class="fixed-action-btn tooltipped" style="bottom: 50px; right: 19px;" data-position="left" data-delay="50" data-tooltip="Tambah">
                        <a class="btn-floating btn-large" href="<?php echo base_url()?>ms_potensi/tambah ">
    ...
    $(document).on('click', '.link_delete', function (e) {
     ...
     $(document).on('click', '.link_foto', function (e) {
          var idtblpotensi = $(this).attr('data-idtbl');
          var type = $(this).attr('data-type');
          var nama = $(this).attr('data-nama');
          $.ajax({
             type: "POST",
             url: "<?php echo base_url();?>ms_potensi/get_image",
          ...
          $("#title_foto").html("Foto potensi "+nama);
    ...
    //   });
     ...
     $(document).on('click', '.link_map', function (e) {
          ...
          var nama = $(this).attr('data-nama');
          $("#modal_title").text("Koordinat potensi : "+nama);
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>Ms_potensi/get_potensi",
           dataType: 'json',
            beforeSend:function()
            {
