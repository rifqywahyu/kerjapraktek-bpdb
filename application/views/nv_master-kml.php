  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Master Peta Kawasan Rawan Bencana Gunung Merapi</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Master Peta Kawasan Rawan Bencana Gunung Merapi</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Master Peta Kawasan Rawan Bencana Gunung Merapi</h3>
                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      <td>krb1.kml</td>
                      <td>kml</td>
                      <td>http://kebencanaan.slemankab.go.id//kml/krb1.kml</td>
                      <td>Aktif</td>
                      <td>
                        <div class="row">
                          <div class="col">
