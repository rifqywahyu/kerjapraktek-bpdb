...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Pengaturan Jarak Aku dan MERAPI
                      </h4>
                      <div class="row">
                        <div class="col s12 m12 l12">
                          ...
                          <thead>
                              <tr>
                                  <th style="width: 10%;">Jarak Aman</th>
                                  <th style="width: 10%;">Status Aktivitas</th>  
                  ...
                  <!-- <div class="row">
                    ...
                    <div id="modal1" class="modal">
                      <div class="modal-header">
                          <h4 class="modal-title jarakaman-delete" style="text-align:center;">Konfirmasi Hapus</h4>
                      </div>
                      <hr />
                    ...
                    <div id="modal2" class="modal" style="height:500px;">
                      ...
                      <div class="modal-content">
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_jarak/proses" method="post">
                            <div class="row">
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input id="name3" name="jarakaman" type="text" required data-error=".errorTxt1">
                                <div class="errorTxt1"></div>
                                <label for="first_name">Jarak Aman</label>
                              </div>
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="statusaktivitas" type="text" required data-error=".errorTxt2">
                                <div class="errorTxt2"></div>
                                <label for="first_name">Status Aktivitas</label>
                              </div>
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="rekomendasi" type="text" required data-error=".errorTxt2">
                                <div class="errorTxt2"></div>
                                <label for="first_name">Rekomendasi</label>
                              </div>
                      ...
                      <div id="modal_edit" class="modal">
                        <div class="modal-header">
                            <h4 class="modal-title jarakaman-ubah" style="text-align:center;"></h4>
                        </div>
                        <hr />
                        <div class="modal-content">
                          <div class="row">
                            <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_jarak/proses" method="post">
                              <div class="row">
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                  <input id="jarakaman" name="jarakaman" type="text" required data-error=".errorTxt1">
                                  <div class="errorTxt1"></div>
                                  <label for="first_name" id="lbl_jarakaman"  >Jarak Aman</label>
                                </div>
                                <div class="input-field col m6 s12">
                                  <i  class="mdi-action-account-circle prefix"></i>
                                  <input id="statusaktivitas" name="statusaktivitas" type="text" required data-error=".errorTxt2">
                                  <input id="id" name="id" type="hidden">
                                  <div class="errorTxt2"></div>
                                  <label id="lbl_statusaktivitas" for="first_name">Status Aktivitas</label>
                                </div>
                                <div class="input-field col m6 s12">
                                  <i  class="mdi-action-account-circle prefix"></i>
                                  <input id="statusaktivitas" name="statusaktivitas" type="text" required data-error=".errorTxt2">
                                  <input id="id" name="id" type="hidden">
                                  <div class="errorTxt2"></div>
                                  <label id="lbl_rekomendasi" for="first_name">Rekomendasi</label>
                                </div>
                              </div>
                                <div class="row">
                                  <div class="input-field col s12">
    ...
    $(document).on('click', '.link_delete', function (e) {
         ...
         var jarakaman = $(this).attr('data-jarakaman');
         var statusaktivitas = $(this).attr("data-statusaktivitas");
         var rekomendasi = $(this).attr("data-rekomendasi");
         if (status == 'hapus') {
           $(".jarakaman-delete").text("Konfirmasi Delete Data "+jarakaman);
         }else{
           $(".jarakaman-delete").text("Konfirmasi aktivasi Data "+jarakaman);
         }
     ...
     $(document).on('click', '.btn-edit', function (e) {
          $("#lbl_jarakaman,#lbl_statusaktivitas").addClass("active");
          ...
          // console.log(unit);
          $("#jarakaman").val(jarakaman);
          $("#statusaktivitas").val(statusaktivitas);
          $("#rekomendasi").val(rekomendasi);
          $("#id").val(id);

          $(".jarakaman-ubah").text("Ubah Data "+jarakaman);
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>ms_jarak/get_jarak/",
           dataType: 'json',
            beforeSend:function()
            {
