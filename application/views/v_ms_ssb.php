...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Master ssb</h4>
                      <div class="row">
                  ...
                  <!-- <div class="row">
                    ...
                    <div class="fixed-action-btn tooltipped" style="bottom: 50px; right: 19px;" data-position="left" data-delay="50" data-tooltip="Tambah">
                        <a class="btn-floating btn-large" href="<?php echo base_url()?>ms_ssb/tambah ">
    ...
    $(document).on('click', '.link_delete', function (e) {
     ...
     $(document).on('click', '.link_foto', function (e) {
          ...
          $.ajax({
             type: "POST",
             url: "<?php echo base_url();?>ms_ssb/get_image",
          ...
          $("#title_foto").html("Foto ssb "+nama);
          // $("#data_icon").attr("src", "<?php echo base_url()?>uploads/ssb/"+foto);
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>Ms_ssb/get_ssb",
           dataType: 'json',
            beforeSend:function()
            {
