                  ...
                  <div class="row">
                    <div class="col s12 m12 l12">
                      <div class="card-panel">
                        <h4 class="header2">Tambah Master Cuaca</h4>
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_cuaca/proses_tambah" method="post">
                            <div class="row">
                            ...
                            <div class="row">
                              <div class="input-field col s12">
                                ...
                                <textarea id="message3" name="ket" class="materialize-textarea" data-error=".errorTxt2"></textarea>
