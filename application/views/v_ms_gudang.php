...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Master gudang
                      </h4>
                      <div class="row">
                  ...
                  <!-- <div class="row">
                    ...
                    <div id="modal2" class="modal" style="height:500px;">
                      ...
                      <div class="modal-content">
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_gudang/proses" method="post">
                            <div class="row">
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input id="name3" name="nama" type="text" required data-error=".errorTxt1">
                                <div class="errorTxt1"></div>
                                <label for="first_name">Nama gudang</label>
                              </div>
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <select style="" name="kelurahan" class="select">
                                  <option value="" disabled selected> -- pilih kelurahan (Tidak Wajib)  --</option>
                            ...
                            <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_gudang/proses" method="post">
                              <div class="row">
                                <div class="input-field col m6 s12">
                                  ...
                                  <div class="errorTxt1"></div>
                                  <label for="first_name" id="lbl_gudang"  >Nama gudang</label>
                                </div>
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                  <select id="kel" name="kelurahan" class="select" required  data-error=".errorTxt23">
    ...
    $(document).on('click', '.link_delete', function (e) {
     ...
     $(document).on('click', '.btn-edit', function (e) {
          $("#lbl_gudang,#lbl_des").addClass("active");

          var kel = $(this).attr("data-kel");
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>ms_gudang/get_gudang/",
           dataType: 'json',
            beforeSend:function()
            {
