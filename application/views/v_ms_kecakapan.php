...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Master kecakapan
                      </h4>
                      <div class="row">
                  ...
                  <!-- <div class="row">
                    ...
                    <div id="modal2" class="modal" style="height:500px;">
                      ...
                      <div class="modal-content">
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_kecakapan/proses" method="post">
                            <div class="row">
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input id="name3" name="nama" type="text" required data-error=".errorTxt1">
                                <div class="errorTxt1"></div>
                                <label for="first_name">Nama kecakapan</label>
                              </div>
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                            ...
                            <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_kecakapan/proses" method="post">
                              <div class="row">
                                <div class="input-field col m6 s12">
                                  ...
                                  <div class="errorTxt1"></div>
                                  <label for="first_name" id="lbl_kecakapan"  >Nama kecakapan</label>
                                </div>
                                <div class="input-field col m6 s12">
                                  <i  class="mdi-action-account-circle prefix"></i>
    ...
    $(document).on('click', '.link_delete', function (e) {
     ...
     $(document).on('click', '.btn-edit', function (e) {
          $("#lbl_kecakapan,#lbl_des").addClass("active");
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>ms_kecakapan/get_kecakapan/",
           dataType: 'json',
            beforeSend:function()
            {
