                            ...
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="card-panel">
                                        ...
                                        <div class="row">
                                            <form class="col s12" id="formValidate" enctype="multipart/form-data" action="<?php echo base_url()?>tr_absensi/proses_tambah" method="post">
                                                <div class="row">
                                                  <div class="row">
                                                    <div class="input-field col m5 s12" style="padding-left:55px;">
                                                        <select name="no_induk" id="no_induk" class="select" required title="Harap Di pilih" data-error=".errorTxt3">
                                                            ...
                                                            <?php foreach($relawan as $row){ ?>
                                                                <option value="<?php echo $row->no_induk?>">
                                                    ...
                                                    <div class="input-field col m1"></div>
                                                      <div class="input-field col m5 s12" style="padding-left:55px;">
                                                          <select name="kegiatan" id="kegiatan" class="select" required title="Harap Di pilih" data-error=".errorTxt3">
                                                              ...
                                                              <?php foreach($kegiatan as $row){ ?>
                                                                  <option value="<?php echo $row->idtblkegiatan?>">
                                                      ...
                                                      <div class="input-field col m4 s12">
                                                          ...
                                                          <input name="tanggal" type="date" class="datepicker" required data-error=".errorTxt11" value="<?php echo date((" Y-m-d "), strtotime('1990-01-01'))?>">
