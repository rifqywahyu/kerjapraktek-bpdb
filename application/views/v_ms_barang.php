...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Master barang
                      </h4>
                      <div class="row">
                  ...
                  <!-- <div class="row">
                    ...
                    <div id="modal2" class="modal" style="height:500px;">
                      ...
                      <div class="modal-content">
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_barang/proses" method="post">
                            <div class="row">
                              ...
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <?php $sel_status = array("pcs", "st", "dus", "kaleng", "kg", "gram", "lt", "rupiah"); ?>
                                <select style="" name="uom" class="select" required  data-error=".errorTxt23">
                      ...
                      <div id="modal_edit" class="modal">
                        ...
                        <div class="modal-content">
                          <div class="row">
                            <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_barang/proses_edit" method="post">
                              <div class="row">
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                  <input id="nama" name="nama" type="text" required data-error=".errorTxt1">
                                  <div class="errorTxt1"></div>
                                  <label for="first_name" id="lbl_barang"  >Nama barang</label>
                                </div>
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                  <select id="unit" name="uom" class="select" required  data-error=".errorTxt23">
                                    <option value="" disabled selected> -- pilih unit  --</option>
                                    <?php foreach($sel_status as $row){ ?>
                                    <option value="<?php echo $row?>"><?php echo $row?></option>
                                  <?php } ?>
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>ms_barang/get_barang/",
           dataType: 'json',
            beforeSend:function()
            {
