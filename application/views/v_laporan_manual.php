                  ...
                  <div class="row">
                    <div class="col s12 m12 l12">
                      ...
                      <div class="card-panel" style="padding-top:1px;">
                        ...
                        <div class="card-panel" style="margin-bottom:30px;">
                        <h4 class="header" style="text-align : center; margin-top:15px; margin-bottom:0px;">Korban Terdampak (KK)</h4>
                            <div class="row" style="margin-top:15px;">
                          ...
                          <div class="card-panel" style="margin-bottom:30px;">
                          <h4 class="header" style="text-align : center; margin-top:15px; margin-bottom:0px;">Riwayat Penanganan</h4>
                            <div class="row" style="margin-top:15px;">
                            ...
                            <div class="row">
                              <div class="input-field col m4 s12" style="padding-left:55px; width:29%;">
                                <select id="kk" class="select"  data-error=".errorTxt31">
                                  <option value="" disabled selected> -- Pilih Jenis Penanganan --</option>
                                  <?php foreach($kk as $row){ ?>
                                  <option value="<?php echo $row->idtblkk?>" data-nama="<?php echo $row->nama?>"><?php echo $row->nama?></option>
                                <?php } ?>
                                </select>
                              ...
                              <div class="input-field col m1 s12"> </div>
                                <div class="input-field col m4 s12">
                                  <button class="btn waves-effect waves-light deep-purple" type="button" id="add_kk">Tambah ke table Progres
                                    <i class="mdi-editor-border-color right"></i>
                                  </button>
                                </div>
                                <div class="input-field col m8 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="rangkuman_korban" type="text" required data-error=".errorTxt16">
                                <label for="first_name">Progres Penanganan</label>
                                <div class="warna_error errorTxt16"></div>
                              </div>
                            ...
                            <div class="row" style="margin:20px;">
                              <div class="row" style="margin-bottom:50px;">
                                <div class="col s12 m12 l12">
                                  ...
                                  <thead>
                                      <tr>
                                          <th style="width: 10%;">Jenis Penanganan</th>
                          ...
                          <div class="card-panel" style="margin-bottom:30px;">
                        <h4 class="header" style="text-align : center; margin-top:15px; margin-bottom:0px;">Bantuan Logistik</h4>
                        <div class="row" style="margin-top:15px;">
                          <div class="input-field col m4 s12" style="padding-left:55px; width:29%;">
                            <!-- <i class="mdi-action-account-circle prefix"></i> -->
                            <select id="kerusakan" class="select"  data-error=".errorTxt1">
                              <option value="" disabled selected> -- Pilih Logistik Bantuan --</option>
                              <?php foreach($dampak as $row){ ?>
                              <option value="<?php echo $row->idtbldampak?>" data-nama="<?php echo $row->nama?>"><?php echo $row->nama. " (".$row->satuan.')'?></option>
                            <?php } ?>
                            </select>
                          ...
                          <div class="input-field col m2 s12">
                            ...
                            <input id="jumlah" type="number" data-error=".errorTxt2">
                            <div class="errorTxt2 warna_error"></div>
                            <label for="first_name">Qty Barang</label>
                          </div>

                            <div class="input-field col m4 s12">
                              <button class="btn waves-effect waves-light light-green darken-4" type="button" id="add">Tambah ke table Bantuan
                                <i class="mdi-editor-border-color right"></i>
                              </button>
                            </div>
                        </div>
