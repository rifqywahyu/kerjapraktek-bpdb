...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Transaksi kegiatan</h4>
                      <div class="row">
                        <div class="col s12 m12 l12">
                          ...
                          <thead>
                              <tr>
                                  ...
                                  <th style="width: 7%;">Tanggal Kegiatan</th>
                  ...
                  <!-- <div class="row">
                    ...
                    <div class="fixed-action-btn tooltipped" style="bottom: 50px; right: 19px;" data-position="left" data-delay="50" data-tooltip="Tambah">
                        <a class="btn-floating btn-large" href="<?php echo base_url()?>tr_kegiatan/tambah ">
    ...
    $(document).on('click', '.link_delete', function (e) {
     ...
     $(document).on('click', '.link_foto', function (e) {
          ...
          $.ajax({
             type: "POST",
             url: "<?php echo base_url();?>tr_kegiatan/get_image",
          ...
          $("#title_foto").html("Foto kegiatan "+nama);
          // $("#data_icon").attr("src", "<?php echo base_url()?>uploads/kegiatan/"+foto);
    ...
    //   });
     ...
     $(document).on('click', '.link_map', function (e) {
          ...
          var nama = $(this).attr('data-nama');
          $("#modal_title").text("Koordinat kegiatan : "+nama);
          elos_ganteng(latitude, longitude);
          // console.log(link+"_"+nama);
          // $("#data_icon").attr("src", "<?php echo base_url()?>uploads/kegiatan/"+icon);
          $('#modal5').openModal();
         e.preventDefault();
      });
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>tr_kegiatan/get_kegiatan",
           dataType: 'json',
            beforeSend:function()
            {
