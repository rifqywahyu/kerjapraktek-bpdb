...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Master user
                      </h4>
                      <div class="row">
                  ...
                  <!-- <div class="row">
                    ...
                    <div id="modal2" class="modal">
                      ...
                      <div class="modal-content">
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_user/proses_tambah" method="post">
                            <div class="row">
                              ...
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="email" type="email" required data-error=".errorTxt2">
                            ...
                            <div class="row">
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <select style="" name="group"  required  data-error=".errorTxt23">
                                  <option value="" disabled selected> -- pilih Group  --</option>
                                  <?php foreach($groups as $rows){ ?>
                                  <option value="<?php echo $rows->idtblgroup?>"><?php echo $rows->nama?></option>
                                <?php } ?>

                                </select>
                                <div class="warna_error errorTxt23"></div>
                              </div>
                            </div>
                            <div class="row">
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="password" type="password" required data-error=".errorTxt3">
                                <div class="errorTxt3"></div>
                                <label for="first_name">Password</label>
                              </div>
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="repass" type="password" required data-error=".errorTxt4">
                      ...
                      <div id="modal_edit" class="modal">
                        ...
                        <div class="modal-content">
                          <div class="row">
                            <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_user/proses_edit" method="post">
                              <div class="row">
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                  <input id="nama" name="nama" type="text" required data-error=".errorTxt1">
                                  <div class="errorTxt1"></div>
                                  <label for="first_name" id="lbl_user"  >Nama user</label>
                                </div>
                                <div class="input-field col m6 s12">
                                  <i  class="mdi-action-account-circle prefix"></i>
                                  <input id="email" name="email" type="text" required data-error=".errorTxt2">
                                  <input id="id" name="id" type="hidden">
                                  <div class="errorTxt2"></div>
                                  <label id="lbl_des" for="first_name">email</label>
                                </div>
                              </div>
                              <div class="row">
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                  <select id="group" name="group" class="select" required  data-error=".errorTxt23">
                                    <option value="" disabled selected> -- pilih Group  --</option>
                                    <?php foreach($groups as $row){ ?>
                                    <option value="<?php echo $row->idtblgroup?>"><?php echo $row->nama?></option>
                                  <?php } ?>
                              ...
                              <div class="row">
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                  <input name="password" type="password" data-error=".errorTxt3">
                                  <div class="errorTxt1"></div>
                                  <label for="first_name">Ubah Password</label>
                                </div>
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                  <input name="repass" type="password" data-error=".errorTxt4">
                                  <div class="errorTxt4"></div>
                                  <label for="first_name">Re-type Password</label>
                                </div>
                              </div>
                                <div class="row">
                                  <div class="input-field col s12">
                                    <button class="btn cyan waves-effect waves-light right" type="submit" value="ubah" name="action">Submit
                                      <i class="mdi-content-send right"></i>
                                    </button>
                                  </div>
                                </div>
    ...
    $(document).on('click', '.link_delete', function (e) {
     ...
     $(document).on('click', '.btn-edit', function (e) {
          $("#lbl_user,#lbl_des").addClass("active");
          ...
          $("#nama").val(nama);
          $("#email").val(email);
          $('#group option[value="'+group+'"]').prop("selected", true);
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>ms_user/get_user/",
           dataType: 'json',
            beforeSend:function()
            {
