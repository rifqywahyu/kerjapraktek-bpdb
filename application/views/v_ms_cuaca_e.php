...
<body id="layouts-horizontal">
                  ...
                  <div class="row">
                    <div class="col s12 m12 l12">
                      <div class="card-panel">
                        ...
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_cuaca/proses_edit" method="post">
                            <div class="row">
                              <div class="input-field col s12">
                                ...
                                <label for="first_name">Nama Cuaca</label>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="input-field col s12">
                                ...
                                <textarea id="message3" name="ket" class="materialize-textarea" data-error=".errorTxt2"><?php echo $data->ket?></textarea>
                                <div class="errorTxt2"></div>
                                <label for="message">ket</label>
                              </div>
                            </div>
                            <div class="row">
    ...
    $("#formValidate").validate({
      rules: {
       ...
       $("#file-1").fileinput({
            'allowedFileExtensions' : ['ico', 'png', 'jpg', 'jpeg'],
            maxFileSize: 40,
            maxFileCount: 1,
            showUpload: false,
            <?php if($data->icon != ''){?> //jika dia ada icon
            initialPreview: [
                '<img src="<?php echo base_url()?>uploads/cuaca/<?php echo $data->icon?>" class="file-preview-image">',
            ],
            initialPreviewConfig: [
                {
                  caption: "<?php echo $data->icon?>",
                  width: "120px",
                  url: '<?php echo base_url()?>ms_cuaca/delete_pict/<?php echo md5($data->id).'/'.$data->icon?>',
