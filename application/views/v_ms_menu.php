...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Master menu
                      </h4>
                      <div class="row">
                        <div class="col s12 m12 l12">
                          ...
                          <thead>
                              <tr>
                                  ...
                                  <th style="width: 10%;">Menu Parent</th>
                  ...
                  <!-- <div class="row">
                    ...
                    <div id="modal2" class="modal">
                      ...
                      <div class="modal-content">
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_menu/proses_tambah" method="post">
                            <div class="row">
                              ...
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="icon" type="text" required data-error=".errorTxt2">
                                <div class="errorTxt2"></div>
                                <label for="first_name">Icon ( <a target="_blank" href="<?php echo base_url()?>main/icon">List Icon</a> )</label>
                              </div>
                            </div>
                            <div class="row">
                              <div class="input-field col m6 s12">
                                <select name="parent" class="select" required  data-error=".errorTxt3">
                                  <option value="" disabled selected> -- Pilih parent --</option>
                                  <?php foreach($parent_menu as $row){ ?>
                                  <option value="<?php echo $row->idtblmenu?>"><?php echo $row->menu ?></option>
                                <?php } ?>
                                </select>
                              ...
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="url" type="text" required data-error=".errorTxt4">
                      ...
                      <div id="modal_edit" class="modal">
                        ...
                        <div class="modal-content">
                          <div class="row">
                            <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_menu/proses_edit" method="post">
                              <div class="row">
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                  <input id="nama" name="nama" type="text" required data-error=".errorTxt1">
                                  <div class="errorTxt1"></div>
                                  <label for="first_name" id="lbl_menu"  >Nama menu</label>
                                </div>
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                  <input id="icon" name="icon" type="text" required data-error=".errorTxt2">
                                  <div class="errorTxt2"></div>
                                  <label id="lbl_ico" for="first_name">Icon ( <a target="_blank" href="<?php echo base_url()?>main/icon">List Icon</a> )</label>
                                  <input id="id" name="id" type="hidden">
                                </div>
                              </div>
                              <div class="row">
                                <div class="input-field col m6 s12">
                                  <select name="parent" id="parent" class="select" required  data-error=".errorTxt3">
                                    <option value="" disabled selected> -- Pilih parent --</option>
                                    <?php foreach($parent_menu as $row){ ?>
                                    <option value="<?php echo $row->idtblmenu?>"><?php echo $row->menu ?></option>
                                  <?php } ?>
                                ...
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                  <input id="url" name="url" type="text" required data-error=".errorTxt4">
                                  <div class="errorTxt4"></div>
                                  <label id="lbl_url" for="first_name">Url</label>
                                </div>
                              </div>
                                <div class="row">
                                  <div class="input-field col s12">
    ...
    $(document).on('click', '.link_delete', function (e) {
     ...
     $(document).on('click', '.btn-edit', function (e) {
          $("#lbl_menu,#lbl_ico,#lbl_url").addClass("active");
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>ms_menu/get_menu/",
           dataType: 'json',
            beforeSend:function()
            {
