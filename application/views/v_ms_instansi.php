...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Master instansi
                      </h4>
                      <div class="row">
                        <div class="col s12 m12 l12">
                          ...
                          <thead>
                              <tr>
                                  ...
                                  <th style="width: 10%;">Status Nomor</th>
                                  <th style="width: 10%;">Publishing</th>
                  ...
                  <!-- <div class="row">
                    ...
                    <div id="modal1" class="modal">
                     ...
                     <div id="modal3" class="modal">
                      <div class="modal-header">
                          <h4 class="modal-title nama-delet" style="text-align:center;">Konfirmasi Penampilan</h4>
                      </div>
                      <hr />
                      <div class="modal-content">
                        <p>Apakah Anda Yakin ?</p>
                      ...
                      <div class="modal-footer">
                        <a class="btn waves-effect waves-light blue modal-close" type="submit" style="margin-left:5px;">Batal <i class="mdi-content-clear right"></i></a>
                        <a class="btn waves-effect waves-light " type="submit" id="button-modal-delet">Proses <i class="mdi-content-send right"></i></a>
                      </div>
                    </div>
                    ...
                    <div id="modal2" class="modal">
                      ...
                      <div class="modal-content">
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_instansi/proses_tambah" method="post">
                            <div class="row">
                              ...
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="deskripsi" type="text" required data-error=".errorTxt3">
                                <div class="errorTxt3"></div>
                                <label for="first_name">deskripsi</label>
                              </div>
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="telp" type="text" required data-error=".errorTxt4">
                                <div class="errorTxt4"></div>
                                <label for="first_name">Nomor Telephone</label>
                              </div>
                            </div>
                              <div class="row">
                      ...
                      <div id="modal_edit" class="modal">
                        ...
                        <div class="modal-content">
                          <div class="row">
                            <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_instansi/proses_edit" method="post">
                              <div class="row">
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                  <input id="nama" name="nama" type="text" required data-error=".errorTxt1">
                                  <div class="errorTxt1"></div>
                                  <label for="first_name" id="lbl_instansi"  >Nama instansi</label>
                                </div>
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                ...
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                  <input id="tlpn" name="telp" type="text" required data-error=".errorTxt4">
                                  <div class="errorTxt4"></div>
                                  <label for="first_name" id="lbl_tlpn">Nomor Telephone</label>
                                </div>
                              </div>
                                <div class="row">
                                  <div class="input-field col s12">
    ...
    $(document).on('click', '.link_delete', function (e) {
         ...
         if (status == 'tampil') {
           $(".nama-delete").text("Konfirmasi Tampilkan Data "+nama);
         }else{
           $(".nama-delete").text("Konfirmasi Sembunyikan Data "+nama);
         }
    ...
    $(document).on('click', '.link_delet', function (e) {
         var link = $(this).attr('href');
         var nama = $(this).attr('data-nama');
         var status = $(this).attr("data-status");
         if (status == 'hapus') {
           $(".nama-delet").text("Konfirmasi Hapus Data "+nama);
         }else{
           $(".nama-delet").text("Konfirmasi aktivasi Data "+nama);
         }
         $("#button-modal-delet").attr('href',link);
         $('#modal3').openModal();
        e.preventDefault();
     });

     $(document).on('click', '.btn-edit', function (e) {
          $("#lbl_instansi,#lbl_des,#lbl_alamat,#lbl_tlpn").addClass("active");
          ...
          $("#deskripsi").val(deskripsi); $("#tlpn").val(tlpn);
          $("#id").val(id);
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>ms_instansi/get_instansi/",
           dataType: 'json',
            beforeSend:function()
            {
