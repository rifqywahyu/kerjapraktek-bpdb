  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Master Bencana</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Master Bencana</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Master Bencana</h3>
              ...
              <div class="card-body table-responsive p-0" style="height: 500px;">
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      <td>ANGIN KENCANG</td>
                      <td>Angin Kencang yang menyebabkan pohon tumbang</td>
                      <td>Aktif</td>
                      <td>
                        <button type="button" class="btn btn-block btn-info">Icon</button>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>TANAH LONGSOR</td>
                      <td>Longsoran tanah berupa batuan maupun tanah</td>
                      <td>Aktif</td>
                      <td>
                        <button type="button" class="btn btn-block btn-info">Icon</button>
                      </td>
