                  ...
                  <div class="row">
                    <div class="col s12 m12 l12">
                      <div class="card-panel">
                        <h4 class="header2">Tambah Master ews</h4>
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_ews/proses_tambah" method="post">
                            <div class="row">
                            ...
                            <div class="row">
                              ...
                              <div class="input-field col m6 s12">
                                <!-- <i class="mdi-action-account-circle prefix" style="margin-right:3rem;"></i> -->
