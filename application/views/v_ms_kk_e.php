                  ...
                  <div class="row">
                    <div class="col s12 m12 l12">
                      <div class="card-panel">
                        <h4 class="header2">Ubah Master kk : <b><?php echo $data->nama.' ('.$data->nokk.')'?></b></h4>
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_kk/proses_edit" method="post">
                            <div class="row">
                              ...
                              <div class="input-field col m4 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <?php $sel_status = array("suami", "istri"); ?>
                            ...
                            <div class="row">
                              <div class="input-field col m4 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="nokk" type="text" required data-error=".errorTxt4" value="<?php echo $data->nokk?>">
                              ...
                              <div class="input-field col m4 s12">
                                <select name="kelurahan" id="kelurahan" class="select" required  data-error=".errorTxt3">
                                  ...
                                  <option value="<?php echo $row->id_kel?>"<?php if($row->id_kel == $data->kelurahan) echo 'selected'?>><?php echo $row->nama ?></option>
                                <?php } ?>
                                </select>
                              ...
                              <div class="input-field col m4 s12">
                                <select name="desa" id="desa" class="select" data-error=".errorTxt6">
                                  ...
                                  <option value="<?php echo $row->idtbldusun?>"<?php if($row->idtbldusun == $data->idtbldusun) echo 'selected'?>><?php echo $row->nama ?></option>
                                <?php } ?>
                                </select>
                            ...
                            <div class="row">
                              <div class="input-field col m4 s6">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="rt" type="text" required data-error=".errorTxt13" value="<?php echo $data->rt?>">
                                <div class="warna_error errorTxt13"></div>
                                <label for="first_name">RT</label>
                              </div>
                              <div class="input-field col m4 s6">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="rw" type="text" required data-error=".errorTxt14" value="<?php echo $data->rw?>">
