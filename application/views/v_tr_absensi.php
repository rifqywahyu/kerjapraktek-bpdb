...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Transaksi absensi</h4>
                      <div class="row">
                        <div class="col s12 m12 l12">
                          <table id="example" class="table table-condensed table-hover datatable" cellspacing="0" width="100%">
                          <thead>
                              <tr>
                                  <th style="width: 10%;">No absensi</th>
                                  <th style="width: 7%;">Nama Induk</th>
                                  <th style="width: 7%;">Nama Relawan</th>
                                  <th style="width: 7%;">Kegiatan</th>
                  ...
                  <!-- <div class="row">
                    ...
                    <div class="fixed-action-btn tooltipped" style="bottom: 50px; right: 19px;" data-position="left" data-delay="50" data-tooltip="Tambah">
                        <a class="btn-floating btn-large" href="<?php echo base_url()?>tr_absensi/tambah ">
    ...
    $(document).on('click', '.link_delete', function (e) {
     ...
     $(document).on('click', '.link_foto', function (e) {
          ...
          $.ajax({
             type: "POST",
             url: "<?php echo base_url();?>tr_absensi/get_image",
          ...
          $("#title_foto").html("Foto absensi "+nama);
          // $("#data_icon").attr("src", "<?php echo base_url()?>uploads/absensi/"+foto);
    ...
    //   });
     ...
     $(document).on('click', '.link_map', function (e) {
          ...
          var nama = $(this).attr('data-nama');
          $("#modal_title").text("Koordinat absensi : "+nama);
          elos_ganteng(latitude, longitude);
          // console.log(link+"_"+nama);
          // $("#data_icon").attr("src", "<?php echo base_url()?>uploads/absensi/"+icon);
          $('#modal5').openModal();
         e.preventDefault();
      });
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>tr_absensi/get_absensi",
           dataType: 'json',
            beforeSend:function()
            {
