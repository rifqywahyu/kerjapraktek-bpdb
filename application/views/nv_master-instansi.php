          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Approval Kejadian</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pelaporan Lengkap</p>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Informasi dan Peringatan Dini</p></p>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master Kecakapan</p></p>
                </a>
              </li>
              <li class="nav-item">
                <a href="" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master Komunikasi</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="" class="nav-link">
              ...
              <li class="nav-item">
                <a href="" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Kegiatan Komunitas Relawan</p>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Potensi Penanganan Covid</p></p>
                </a>
              </li>
            </ul>
          </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Master Instansi</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Master Instansi</h3>
                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      <td>Bayu Induk</td>
                      <td>0274 869375</td>
                      <td>Komplek Pemda Sleman, Jl. Prasamya Sleman</td>
                      <td>BPBD Sleman</td>
                      <td>Tidak Aktif</td>
                      <td>Tidak Tampil</td>
                      <td>
                        <div class="row">
                          <div class="col">
                            ...
                            <button type="button" class="btn btn-block btn-primary">Aktivasi</button>
                            <button type="button" class="btn btn-block btn-primary">Tampil</button>
                          </div>
                          <div class="col">
                            <button type="button" class="btn btn-block btn-danger">Sembunyi</button>
